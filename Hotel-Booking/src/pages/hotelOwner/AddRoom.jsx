        ...
        <form>
            ...
            <div className='flex-1 max-w-48'>
                ...
                <select value={inputs.roomType} onClick={e => setInputs({...inputs,roomType:e.target.value})} 
                 className='boarder opacity-70 border-gray-300 mt-1 rounded p-2 w-full'>
                ...
                <div>
                    ...
                    <input type="number" placeholder='0' className='border border-gray-300 mt-1 rounded p-2 w-24' value={inputs.pricePerNight} onChange={e=> setInputs(
