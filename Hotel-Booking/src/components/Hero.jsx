...
import heroImg from "../assets/heroImage.png"; // ✅ correct import
...
const Hero = () => {
  return (
    ...
    >
      ...
      <p className="max-w-[520px] mt-2 text-sm md:text-base text-white/90">
        Unparalleled luxury and Comfort await at the world's most exclusive hotels
        and resorts. Start your journey today.
      </p>

      {/* Form */}
      <form className="bg-white text-gray-500 rounded-lg px-6 py-4 mt-8 flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto mt-8 w-full max-w-4xl">
        <div>
