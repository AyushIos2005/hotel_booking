...
const NewsLetter = () => {
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-10 md:py-14 mb-12 md:mb-16">
      <div className="flex md:flex-row flex-col border border-gray-500/30 rounded-2xl items-start md:items-center justify-between gap-8 text-sm max-w-5xl mx-auto bg-white p-6 sm:p-8 md:p-10">
        ...
        <div className="max-w-md w-full">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 mt-8">
            <input
              className="py-2.5 px-3 w-full outline-none focus:border-indigo-500/60 transition border border-gray-500/30 rounded-md"
              type="email"
              placeholder="Enter your email"
            />
            <button className="bg-indigo-500 hover:bg-indigo-600 transition-all px-6 py-2.5 rounded-md text-white font-medium w-full sm:w-auto">
              Subscribe
            </button>
          </div>
        </div>
        ...
        <div className="space-y-4 md:max-w-48">
          <div className="flex items-center gap-3">
            <div className="bg-gray-500/10 w-max p-2.5 rounded-lg">
          ...
          <p className="text-gray-500">
            Get fresh weekly articles with tips, updates, and useful insights delivered to you.
          </p>
        </div>
        ...
        <div className="space-y-4 md:max-w-48">
          ...
          <p className="text-gray-500">
            We only send valuable updates and insights—no promotions, no unnecessary spam.
          </p>
        </div>
